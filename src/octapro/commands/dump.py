...
def _annotate(data: bytes) -> list[tuple[str, str, str]]:
    ...
    return [
        ...
        ("1:31", _h(1, 31), "routing matrix (30 bytes signed-int8 /10.0 dB)"),
        ("31:35", _h(31, 35), f"per-channel GAIN float32 = {_f32(data, 31):+.2f} dB"),
        ("35:39", _h(35, 39), f"per-channel DELAY float32 = {_f32(data, 35):.2f} ms"),
        ("39:43", _h(39, 43), f"HPF freq float32 = {_f32(data, 39):.2f} Hz"),
        ("43", _b(43), "HPF slope code  (dB/oct = (code+1)*6; 0x00=6 … 0x07=48)"),
        ("44", _b(44), "HPF filter type (0=Linkwitz-Riley, 1=Bessel, 2=Butterworth)"),
        ("45:49", _h(45, 49), f"LPF freq float32 = {_f32(data, 45):.2f} Hz"),
        ("49", _b(49), "LPF slope code"),
        ("50", _b(50), "LPF filter type (0=LR, 1=Bessel, 2=Butterworth)"),
        ("51", _b(51), "UNKNOWN byte (observed 0x00)"),
        ("52", _b(52), "SPEAKER TYPE (1..6 = HF/MF/LF/MHF/MLF/FF)"),
